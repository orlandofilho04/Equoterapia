...
const CadastroEquitador = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.birthDate) {
        ...
        if (isNaN(dateObj.getTime()) || dateObj.getFullYear() < 1920 || dateObj.getFullYear() > new Date().getFullYear()) {
          setError('Por favor, insira uma data de nascimento válida');
          setLoading(false);
          return;
        }
      ...
      const registerData = {
        ...
        regNumber: formData.email.split('@')[0] + "-" + Math.floor(Math.random() * 1000)
      };
      ...
      try {
        ...
        // Handle specific API errors
          ...
          const errorMessage = apiError.response?.data?.message || apiError.response?.data?.detail || 'Erro ao cadastrar equitador. Por favor, tente novamente.';
  ...
  function cadastroSucesso(response, authToken) {
    ...
    try {
      ...
      api.get(`/professional?username=${searchUsername}`, {
        ...
        if (searchResponse.data && searchResponse.data.id) {
          ...
          if (formData.photo) {
            ...
            api.put(`/professional/${newProfessionalId}/photo`, photoFormData, {
              headers: {
    ...
    <div className="container py-4">
      <div className="card shadow-sm border-0 rounded-3 overflow-hidden">
        <div className="card-header bg-white border-0 pt-4 pb-0">
          ...
          <p className="text-muted mb-0">Preencha os dados para cadastrar um novo equitador no sistema</p>
        </div>
        ...
        <Row className="mb-4">
              ...
              <InputMask
                ...
                placeholder="000.000.000-00"
                        className={`form-control form-control-lg ${cpfError ? 'is-invalid' : ''}`}
                        style={{ borderRadius: '8px', border: '1px solid #ced4da' }}
              />
            ...
            <div className="form-section mb-4">
              <div className="d-flex align-items-center mb-3">
                ...
                <h5 className="mb-0 fw-bold" style={{ color: '#343a40' }}>Dados da Formação</h5>
              </div>
              <div className="bg-light p-4 rounded-3">
                <Row className="mb-4">
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      <Form.Text className="text-muted">
                        Especialização técnica ou formação específica para trabalho com cavalos
                      </Form.Text>
                    </Form.Group>
                  </Col>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      <Form.Label className="fw-medium">Data de Formação</Form.Label>
              <Form.Control
                type="date"
                name="formationDate"
