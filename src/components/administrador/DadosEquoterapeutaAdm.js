        ...
        <div className="container my-5">
            <Row className="mb-3">
                ...
                <Col>
                    <div className="d-flex justify-content-between">
                        <div>
                            <h3 className="title-adm color-green">Pedro Fran</h3>
            ...
            <div className="mt-5">
                ...
                <ul className="list-unstyled">
                    <li>
                        <strong className="color-brown">Nome Completo:</strong> Pedro Fran da Silva
                    </li>
                    <li>
            ...
            <div className="mt-5">
                ...
                <ul className="list-unstyled">
                    <li>
                        <strong className="color-brown">Registro Profissional:</strong>  Psicopedagogo - CFEP
                    </li>
                    <li>
                        <strong className="color-brown">Curso da ANDE-BRASIL:</strong> Sim
                    </li>
                </ul>
            </div>
        </div>
